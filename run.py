...
def main():
    ...
    parser.add_argument('--alpha', type=float, default=5, help='class-balanced parameter.')
    parser.add_argument('--beta', type=float, default=1e-1, help='l2 regularization parameter).')
    ...
    AUC = max_auc
    print('\nResult: AUC: {:04f}'.format(AUC), f"Total time: {time.time() - t_total:.22f}s\n")
